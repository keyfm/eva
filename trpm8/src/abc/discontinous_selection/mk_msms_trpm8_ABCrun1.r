...
if (model == 'sdn'){
  ...
  if (pop == 'eur') {
    ...
    alpha = 151.712
    curr_Psize <- 33813
    msmstemplate = " -N 10000 -ms 244 1 -I 2 122 122 0 -t 485.9076 -r 153.8662 516923 -g 2 151.7119 -n 2 3.3813 -n 1 1.4474 -m 1 2 1 -m 2 1 1 -en 0.023 2 0.1861 -ema 0.023 2 x 6 6 x -ej 0.051 2 1 -en 0.148 1 0.731 -SFC -SI [seltime] 2 [initialfrequencyP1] [initialfrequencyP2] -Sc 0 1 0 0 0 -Sc 0 2 0 0 0 -Sc 0.003 1 [selstrengthP1] [halfselstrengthP1] 0 -Sc 0.003 2 [selstrengthP2] [halfselstrengthP2] 0 -Sp 0.18875 -Smark"
  } else if (pop == 'asi') {
    ## Africa vs Asia
    alpha = 191.541
    curr_Psize <- 45369.72
    msmstemplate = " -N 10000 -ms 244 1 -I 2 122 122 0 -t 485.9076 -r 153.8662 516923 -g 2 191.541 -n 2 4.536972 -n 1 1.4474 -m 1 2 0.312 -m 2 1 0.312 -ema 0.023 2 x 6 6 x -en 0.023 2 0.1861 -ej 0.051 2 1 -en 0.148 1 0.731 -SFC -SI [seltime] 2 [initialfrequencyP1] [initialfrequencyP2] -Sc 0 1 0 0 0 -Sc 0 2 0 0 0 -Sc 0.003 1 [selstrengthP1] [halfselstrengthP1] 0 -Sc 0.003 2 [selstrengthP2] [halfselstrengthP2] 0 -Sp 0.18875 -Smark"
  } else {
...
### SSV MODEL
  ...
  if (pop == 'eur') {
    ## Africa vs Europe
    msmstemplate = " -N 10000 -ms 244 1 -I 2 122 122 0 -t 485.9076 -r 153.8662 516923 -g 2 151.7119 -n 2 3.3813 -n 1 1.4474 -m 1 2 1 -m 2 1 1 -en 0.023 2 0.1861 -ema 0.023 2 x 6 6 x -ej 0.051 2 1 -en 0.148 1 0.731 -SFC -SI [seltime] 2 [initialfrequencyP1] [initialfrequencyP2] -Sc 0 2 0 0 0 -Sc 0.003 2 [selstrengthP2] [halfselstrengthP2] 0 -Sp 0.18875 -Smark"
  } else if (pop == 'asi') {
    ## Africa vs Asia
    msmstemplate = " -N 10000 -ms 244 1 -I 2 122 122 0 -t 485.9076 -r 153.8662 516923 -g 2 191.541 -n 2 4.536972 -n 1 1.4474 -m 1 2 0.312 -m 2 1 0.312 -ema 0.023 2 x 6 6 x -en 0.023 2 0.1861 -ej 0.051 2 1 -en 0.148 1 0.731 -SFC -SI [seltime] 2 [initialfrequencyP1] [initialfrequencyP2] -Sc 0 2 0 0 0 -Sc 0.003 2 [selstrengthP2] [halfselstrengthP2] 0 -Sp 0.18875 -Smark"
  } else {
      stop("None of the required populations selected. (eur or asi)")
  }
  ## Build msms command line
